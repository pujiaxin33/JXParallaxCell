...
- (void)initUI
{
    ...
    self.headerImageView.image = [UIImage imageNamed:@"Album4.jpg"];
    [containerView addSubview:self.headerImageView];
    self.contentView.clipsToBounds = YES;
    
    self.nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, [[self class] getHeight]/2 - 20, 200, 40)];
    self.nameLabel.font = [UIFont boldSystemFontOfSize:20];
    self.nameLabel.textAlignment = NSTextAlignmentCenter;
    self.nameLabel.textColor = [UIColor whiteColor];
    self.nameLabel.text = @"愣愣的鹿先生！！！";
